 ...
 */ (function (e) {
  ...
  function r(j) {
    ...
    if (_ !== T) {
      j[0] = _;
      e: for (var W = 0, J = j.length, er = J >>> 1; W < er; ) {
        var gt = 2 * (W + 1) - 1,
          xl = j[gt],
          yt = gt + 1,
          tr = j[yt];
        if (0 > l(xl, _))
          yt < J && 0 > l(tr, xl)
            ? ((j[W] = tr), (j[yt] = _), (W = yt))
            : ((j[W] = xl), (j[gt] = _), (W = gt));
        else if (yt < J && 0 > l(tr, _)) (j[W] = tr), (j[yt] = _), (W = yt);
        else break e;
      }
    }
    return T;
    ...
    (e.unstable_scheduleCallback = function (j, T, _) {
      ...
      return (
        ...
        _ > W
          ...
          : ((j.sortIndex = J), t(a, j), w || x || ((w = !0), gl(N))),
        j
      );
    }),
...
function Vc(e, t, n, r, l, o, i, s, a) {
  (jn = !1), (Lr = null), $c.apply(Uc, arguments);
}
...
var sn = {
  ...
  qi = we(rl),
  sd = V({}, rl, { dataTransfer: 0 }),
  ad = we(sd),
  ud = V({}, Zn, { relatedTarget: 0 }),
  Tl = we(ud),
  cd = V({}, sn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  dd = we(cd),
  fd = V({}, sn, {
...
var xd = V({}, Zn, {
  ...
  Nd = we(Sd),
  jd = V({}, sn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cd = we(jd),
  Ed = V({}, rl, {
    deltaX: function (e) {
...
function zd(e, t) {
  if (Ot)
    return e === "compositionend" || (!ri && $a(e, t))
...
if (Qe) {
  ...
  Ba = _l && (!document.documentMode || 9 < document.documentMode);
}
function os() {
...
var De = typeof Object.is == "function" ? Object.is : $d;
function $n(e, t) {
  if (De(e, t)) return !0;
        ...
        for (var c = d, p; c !== null; ) {
          ...
          if (
            (p.tag === 5 &&
              g !== null &&
              ((p = g),
              f !== null && ((g = Dn(c, f)), g != null && k.push(Vn(c, g, p)))),
            F)
          )
            break;
          c = c.return;
    ...
    if (!(t & 7)) {
      ...
      P &&
        ...
        0 < C.length &&
          ...
          E ? (P.data = E) : ((E = Ua(n)), E !== null && (P.data = E)))),
        (E = _d ? Md(e, n) : zd(e, n)) &&
...
function ds(e, t, n, r, l) {
  for (var o = t._reactName, i = []; n !== null && n !== r; ) {
    ...
    s.tag === 5 &&
      ...
      ((s = d),
      l
        ? ((a = Dn(n, o)), a != null && i.unshift(Vn(n, a, s)))
        : l || ((a = Dn(n, o)), a != null && i.push(Vn(n, a, s)))),
      (n = n.return);
  }
...
function O(e) {
  0 > Ut || ((e.current = xo[Ut]), (xo[Ut] = null), Ut--);
}
function D(e, t) {
  Ut++, (xo[Ut] = e.current), (e.current = t);
}
var pt = {},
  oe = ht(pt),
  fe = ht(!1),
...
function vt() {
  if (!Fl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Ea(Jo, vt), l);
    } finally {
      (R = t), (Fl = !1);
    }
  }
...
function nu(e, t, n) {
  (ke[Se++] = Be), (ke[Se++] = He), (ke[Se++] = Pt), (Pt = e);
  var r = Be;
  e = He;
  var l = 32 - Le(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function Ul(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (o = l.lane), (U.lanes |= o), (_t |= o), (l = l.next);
    while (l !== e);
...
function ju(e, t, n) {
  return Tt & 21
    ? (De(n, t) || ((n = _a()), (U.lanes |= n), (_t |= n), (e.baseState = !0)),
      t)
...
function cf(e, t, n, r, l, o, i) {
  ...
  if (l.data === "$!") {
    ...
    return (r = s), (o = Error(y(419))), (r = Bl(o, r, void 0)), hr(e, t, i, r);
  }
  if (((s = (i & e.childLanes) !== 0), de || s)) {
    ...
    return Pi(), (r = Bl(Error(y(421)))), hr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || $.current & 1 ? G === 0 && (G = 3) : Pi())),
          t.updateQueue !== null && (t.flags |= 4),
          re(t),
          null);
    case 4:
      return (
        nn(), Mo(e, t), e === null && Un(t.stateNode.containerInfo), re(t), null
      );
    case 10:
...
function Vu(e) {
  ...
  t !== null && ((e.alternate = null), Vu(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Fe], delete t[Bn], delete t[yo], delete t[Jd], delete t[Zd])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function me(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Gi(n), t === 1))
      e.tag === 0 ? qd(Us.bind(null, e)) : tu(Us.bind(null, e)),
        Gd(function () {
          !(L & 6) && vt();
        }),
        (n = null);
...
function Ku(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = br(e, r);
    ...
    L |= 2;
    var o = Gu();
    (q !== e || ee !== t) && ((Ue = null), (ln = Q() + 500), jt(e, t));
    do
      try {
        wf();
        break;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = go(wt.bind(null, e, ce, Ue), t);
            break;
          }
          wt(e, ce, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = go(wt.bind(null, e, ce, Ue), r);
            break;
          }
          wt(e, ce, Ue);
          break;
...
function br(e, t) {
  ...
  while (!0);
  if ((ui(), (L = n), (Jr.current = r), K !== null)) throw Error(y(261));
...
wa = Ci;
ka = Mt;
var zf = { usingClientEntryPoint: !1, Events: [qn, $t, il, ya, xa, Ci] },
  yn = {
 ...
 */ const Wf = Je("X", [
  ...
  Yf = "/assets/capa1-CN0_gccv.webp",
  Gf = "/assets/capa2-CpuJwy3l.webp",
  Xf = "/assets/capa3-CZ6k0NUE.webp",
  Jf = "/assets/Riba-CHNQaOsJ.webp",
  Qs = [
    { src: Yf, position: "40% center" },
    { src: Gf, position: "86% 20%" },
    { src: Xf, position: "53% center" },
    { src: Jf, position: "55% center" },
  ],
  Zf = () => {
  ...
  qf = "/assets/ribaDesenho-Dsjlu5TE.webp",
  Ri = "/assets/treinamento5-Der5bHCZ.webp",
  oc = "/assets/treinamento4-Bw2jSvWi.webp",
  Di = "/assets/tecnica3--Vxgm7Yq.webp",
  ...
  tp = "/assets/selfie_riba-BVPXeG2T.webp",
  np = () => {
    const e = [
  ...
  op = "/assets/flavis_riba-k0PcKre3.webp",
  ip = () => {
    const e = [
        {
  ...
  ap = "/assets/CT1-CWTtI2Jh.webp",
  up = "/assets/CT2-bXMVEH9I.webp",
  cp = "/assets/CT3-D1pp6y9-.webp",
  dp = "/assets/CT4-_0bK0JYo.webp",
  fp = "/assets/CT5-C-a7JvnE.webp",
  pp = "/assets/CT6-CvmiZv9U.webp",
  mp = "/assets/CT7-OZQqzm8H.webp",
  hp = "/assets/CT8-BvKczrFr.webp",
  vp = "/assets/CT9-BSq1BGK8.webp",
  gp = "/assets/evento1-CIHJHV72.webp",
  yp = "/assets/evento2-CL3eaq5N.webp",
  xp = "/assets/evento3-Chh_KScv.webp",
  wp = "/assets/evento4-CUEwHubz.webp",
  kp = "/assets/evento5-GgsdSAWc.webp",
  Sp = "/assets/Riba-CHNQaOsJ.webp",
  Np = "/assets/Riba2-1-DZGOrz3n.webp",
  jp = "/assets/tecnica1-C8ppgENq.webp",
  Cp = "/assets/tecnica2-2eXQYdO3.webp",
  Ep = "/assets/tecnica5-CTKuiPy3.webp",
  Pp = "/assets/tecnica6-DE-VJQXG.webp",
  Tp = "/assets/treinamento1-CjyMbWso.webp",
  _p = "/assets/treinamento2-DdjSZF6P.webp",
  Mp = "/assets/treinamento3-Cx8as-rb.webp",
  zp = "/assets/treinamento6-Bhc2Xckm.webp",
  Lp = "/assets/treinamento7-DPz-Eq_l.webp",
  Rp = "/assets/treinamento8-3vWZYbnQ.webp",
  Dp = "/assets/treinamento9-BJXx4fUV.webp",
  Ip = "/assets/treinamento10-CKCPQuSb.webp",
  Op = "/assets/treinamento11-Wed553S1.webp",
  Fp = () => {
    const e = [
...
lc(document.getElementById("root")).render(
  u.jsx(X.StrictMode, { children: u.jsx(Vp, {}) })
);
